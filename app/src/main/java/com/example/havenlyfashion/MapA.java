...
public class MapA extends AppCompatActivity implements MapEventsReceiver {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        map = (MapView) findViewById(R.id.mapOutletA);
        ...
        outletA.setPosition(g);
        outletA.setTitle("Outlet A");
        outletA.setSnippet("Ciroyom, Kec. Andir, Kota Bandung, Jawa Barat 40182");
